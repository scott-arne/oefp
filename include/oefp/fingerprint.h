...
public:
    ...
    /// \throws std::invalid_argument: When spec.value_type is not Binary or
    ...
    ///
    /// \throws std::out_of_range: When word_index is greater than or equal to
    ///     WordCount().
    ...
    ///
    /// \throws std::out_of_range: When index is greater than or equal to
    ///     SizeBits().
